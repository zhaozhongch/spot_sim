...
class SpotControl:
    ...
    def callback_model(self, data):
        ...
        if current_time - self.show_time > 0.5:
            print("robot position and yaw ",self.x_inst,self.y_inst,self.z_inst, self.yaw_inst)
    ...
    def spot_inverse_control(self):
        ...
        # if p_flag%100 == 0:
        #     print(self.bzg.Tswing)
        #     print("LateralFraction", self.LateralFraction)
        #     print("clearance height ", self.ClearanceHeight)
        #     print("steplength, yaw_desired, stepv, pene_depth", self.StepLength, YawRate_desired, self.StepVelocity, self.PenetrationDepth)
        #     print("pos ", pos)
        #     print("orn ", orn)
            #print(contacts)
            #print(T_bf)
...
def main():
    ...
    #     self.show_time = current_time
    global p_flag
    while t < (int(max_timesteps)) and not rospy.is_shutdown():
        ...
        #print("elapsed time and time step ", elapsed_time, time_step)
