...
class QuadrupedController:
    def __init__(self):
        ...
        self.Tswing = 0.04#original 0.17
        self.ClearanceHeight = 0.15 #original 0.15
        self.PenetrationDepth = 0.00001#original 0.00001
        ...
        # Limits
        self.max_linear_velocity_x = 1.9   # m/sec,original 1.9
    ...
    def velocity_controller(self, vel):
        ...
        print("velocity x and y, angular z, Tswing ", velocity_x, velocity_y, vel.angular.z, self.Tswing)
        print("step length ", self.StepLength)
