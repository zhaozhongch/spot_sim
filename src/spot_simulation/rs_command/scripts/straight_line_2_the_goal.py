...
if __name__ == "__main__":
    ...
    try:
        ...
        ln = 0
        x = -1
        #A simple experiment, assume we dont operate it on the Y
        while abs(pub_thread.x_inst-goal_x)>0.3 and not rospy.is_shutdown():
            ln+=1
            ...
            print("distance to the goal", abs(pub_thread.x_inst-goal_x))
            ...
            z = 0
            th = 0
        print("current distance is ",abs(pub_thread.x_inst-goal_x), " exit")
